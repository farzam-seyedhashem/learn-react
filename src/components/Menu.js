    ...
    return (
        <header className={"fixed top-0 bg-white w-full border-b border-black/12 left-0  z-999 "}>
            ...
            <div className={"container mx-auto flex items-center justify-between w-full h-[72px]"}>
                ...
                <Link href={"/login"}>
                    <button
                        className={"border px-6 h-[40px] text-[16px] font-bold text-zinc-800 flex items-center rounded-lg border-zinc-600 "}>
                        <Icon className={"ml-2"}>
                            login
                        </Icon>
                        ورود و ثبت نام
            ...
            <div className={"container mx-auto flex items-center h-[56px]"}>
                <ul className={"flex flex-1 items-center"}>
                    <li>
                        <Link className={`relative flex items-center font-bold text-black text-[16px] px-6 h-[56px]`}
                              href={"#"}>
                            دسته بندی
                ...
                <div
                    className={"flex items-center justify-center px-6 h-[40px] rounded-full bg-yellow-50 text-yellow-600"}>
                    <Icon className={"ml-2"}>
                        location_on
                    </Icon>
